    ...
    def parse(self, response):
        ...
        for book in books:
            ...
            if 'catalogue/' in relative_url:
                detail_book_url = 'https://books.toscrape.com/' + relative_url
            else:
                detail_book_url = 'https://books.toscrape.com/catalogue/' + relative_url

            yield response.follow(detail_book_url, callback=self.parse_book_page)
